...
export default class Controller {
  constructor(model, view) {
    ...
    this._view.refs.body.addEventListener(
      'click',
      this.handleModalFalseClick.bind(this),
    );

    this._view.refs.siteLogo.addEventListener(
      'click',
    ...
    this._view.refs.loadMoreBtn.addEventListener(
      'click',
    ...
    this._view.refs.modalPage.addEventListener(
      'click',
    ...
    this._view.refs.showFavorite.addEventListener(
      'click',
